...
async function main(args) {
    ...
    modelUpdate = {};
    if (args['slModelPath']) {
        modelUpdate['ecModelFile'] = path.join("/mnt", args['slModelPath'])
    }
    if (args['slScriptPath']) {
        modelUpdate['ecInitScript'] = path.join("/mnt", args['slScriptPath'])
    }
    
    if (args['environmentXmlPath']) {
        modelUpdate['environment'] = path.join("/mnt", args['environmentXmlPath'])
    }
